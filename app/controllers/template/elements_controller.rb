class Template::ElementsController < ApplicationController
  ...
  # POST /elements.json
  def create
    @element = @template.elements.new(params[:element])

    respond_to do |format|
      if @element.save
        format.html { redirect_to template_element_path(@template, @element), notice: 'Element was successfully created.' }
