class Position::LabelsController < ApplicationController
  before_filter :the_position
  
  def example_image
    example_image = Composer.label_preview(@position)
